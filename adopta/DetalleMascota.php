...
// Consulta para obtener datos de la mascota
...
if ($result->fetch_column() > 0) {
    ...
    // Consulta para obtener los interesados en la mascota
    $sql_interesados = "SELECT u.username, u.correo, u.telefono 
                       FROM interesados i 
                       JOIN usuarios u ON i.id_interesado = u.id_usuario 
                       WHERE i.id_mascota = $id_mascota";
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-6">
                <div class="pet-card h-100">
                    ...
                    <div class="card-body">
                        <h3 class="h4 fw-bold mb-3 text-center">Interesados en adoptar</h3>
                        
                        <?php if ($result_interesados->num_rows > 0): ?>
                            <div class="interested-list">
                                <?php while($interesado = $result_interesados->fetch_assoc()): ?>
                                    <div class="interested-item p-3 mb-2 rounded">
                                        <div class="d-flex align-items-center mb-2">
                                            <i class="bi bi-person-circle fs-4 me-2 text-primary"></i>
                                            <h5 class="mb-0 fw-bold"><?php echo $interesado['username']; ?></h5>
                                        </div>
                                        <div class="d-flex align-items-center mb-2">
                                            <i class="bi bi-envelope me-2 text-muted"></i>
                                            <a href="mailto:<?php echo $interesado['correo']; ?>" class="text-decoration-none"><?php echo $interesado['correo']; ?></a>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <i class="bi bi-telephone me-2 text-muted"></i>
                                            <a href="tel:<?php echo $interesado['telefono']; ?>" class="text-decoration-none"><?php echo $interesado['telefono']; ?></a>
                                        </div>
                                    </div>
                                <?php endwhile; ?>
                            </div>
                        <?php else: ?>
                            <div class="text-center py-4">
                                ...
                                <p class="text-muted">Aún no hay interesados en adoptar a <?php echo $nombre_mascota; ?></p>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
